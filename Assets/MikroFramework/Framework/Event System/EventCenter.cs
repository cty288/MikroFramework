...
namespace MikroFramework.Event {
    ...
    public static class EventCenter
    {
        ...
        public static void AddListener(EventType eventType, Action<MikroMessage> callBack)
        {
        ...
        private static void OnListenerRemoving(EventType eventType, Action<MikroMessage> callBack)
        {
            //检查表中是否有该事件类型
            if (eventTable.ContainsKey(eventType))
            {
